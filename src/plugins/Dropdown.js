...
function DropDownItems({ children, dropDownRef, onClose }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "dropdown", ref: dropDownRef, onKeyDown: handleKeyDown },
      children
    )
  );
}
...
export default function DropDown({
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      buttonIconClassName &&
        React.createElement("span", { className: buttonIconClassName }),
      buttonLabel &&
        React.createElement(
          "span",
    ...
    showDropDown &&
      createPortal(
        React.createElement(
          DropDownItems,
          { dropDownRef: dropDownRef, onClose: handleClose },
          children
        ),
        document.body
      )
